...
protected function _getAcl()
{
	...
	$tmroleText=array();
	$tmroleText = array('1'=>'admin','2'=>'management','3'=>'manager','4'=>'HRManager','5'=>'employee','6'=>'user','7'=>'agency','8'=>'sysadmin','9'=>'lead','10'=>'finance');
	...
	if(!isset($role))
	   ...
	   if($role == 2 )
		 ...
		 $acl->addResource(new Zend_Acl_Resource('default:payrollattendancereport'));
                            $acl->allow('HRManager', 'default:payrollattendancereport', array('index','addpopup','getrequests','add','edit','delete','view','Attendance Report'));
		 ...
		 $acl->addResource(new Zend_Acl_Resource('default:apprreqcandidates'));
           ...
           {
		 $acl->addResource(new Zend_Acl_Resource('default:addemployeeleaves'));
                            $acl->allow('finance', 'default:addemployeeleaves', array('index','view','Add Employee Leaves'));

		 $acl->addResource(new Zend_Acl_Resource('default:appraisalcategory'));
                            $acl->allow('finance', 'default:appraisalcategory', array('index','addpopup','getappraisalcategory','add','edit','delete','view','Parameters'));

		 $acl->addResource(new Zend_Acl_Resource('default:appraisalhistoryself'));
                            $acl->allow('finance', 'default:appraisalhistoryself', array('index','view','My Appraisal History'));

		 $acl->addResource(new Zend_Acl_Resource('default:appraisalhistoryteam'));
                            $acl->allow('finance', 'default:appraisalhistoryteam', array('index','getsearchedempcontent','view','Team Appraisal History'));

		 $acl->addResource(new Zend_Acl_Resource('default:appraisalinit'));
                            $acl->allow('finance', 'default:appraisalinit', array('checkappadmin','getdepartmentsadmin','discardsteptwo','displayline','addlinemanager','displayreport','deletelinemanager','deletereportmanager','constructreportacc','constructacc','displayemployees','displaycontentreportacc','displaycontentacc','viewconfmanagers','confmanagers','displaymanagers','displayreportmanagers','getperiod','index','viewassigngroups','assigngroups','displaygroupedemployees','showgroupedemployees','viewgroupedemployees','savegroupedemployeesajax','changesettings','displaysettings','deletegroupedemployees','initializegroup','completeappraisal','checkemployeeresponse','getemployeeslinemanagers','savemngrorghierarchy','getconfiglinemanagers','validateconfig','add','edit','view','Initialize Appraisal'));

		 $acl->addResource(new Zend_Acl_Resource('default:appraisalmanager'));
                            $acl->allow('finance', 'default:appraisalmanager', array('submitmanager','deletemanagergroup','savemanagergroup','index','viewgroup','createnewgroup','showgroups','showviewgroups','edit','view','Manager Appraisal'));

		 $acl->addResource(new Zend_Acl_Resource('default:appraisalquestions'));
                            $acl->allow('finance', 'default:appraisalquestions', array('index','addpopup','savequestionpopup','add','edit','delete','view','Questions'));

		 $acl->addResource(new Zend_Acl_Resource('default:appraisalratings'));
                            $acl->allow('finance', 'default:appraisalratings', array('index','addratings','add','edit','view','Ratings'));

		 $acl->addResource(new Zend_Acl_Resource('default:appraisalself'));
                            $acl->allow('finance', 'default:appraisalself', array('index','save','edit','view','Self Appraisal'));

		 $acl->addResource(new Zend_Acl_Resource('default:appraisalskills'));
                            $appraisalskills_add = 'yes';
                                if($this->id_param == '' && $appraisalskills_add == 'yes')
                                    $acl->allow('finance','default:appraisalskills', array('index','getappraisalskills','saveskillspopup','add','view','Skills','edit'));

                                else
                                    $acl->allow('finance','default:appraisalskills', array('index','getappraisalskills','saveskillspopup','add','view','Skills'));

                                
		 $acl->addResource(new Zend_Acl_Resource('default:appraisalstatus'));
                            $acl->allow('finance', 'default:appraisalstatus', array('index','manager','managerstatus','checkappraisalimplementation','employee','employeestatus','employeeActi','addlinemanager','displaymanagers','updatelinemanager','view','Employee Status'));

		 $acl->addResource(new Zend_Acl_Resource('default:attendancestatuscode'));
                            $acl->allow('finance', 'default:attendancestatuscode', array('index','view','Attendance Status'));

		 $acl->addResource(new Zend_Acl_Resource('default:bankaccounttype'));
                            $acl->allow('finance', 'default:bankaccounttype', array('index','addpopup','view','Bank Account Types'));

		 $acl->addResource(new Zend_Acl_Resource('default:competencylevel'));
                            $acl->allow('finance', 'default:competencylevel', array('index','addpopup','view','Competency Levels'));

		 $acl->addResource(new Zend_Acl_Resource('default:components'));
                            $acl->allow('finance', 'default:components', array('index','addpopup','getrequests','add','edit','delete','view','Components'));

		 $acl->addResource(new Zend_Acl_Resource('default:componentsgroup'));
                            $acl->allow('finance', 'default:componentsgroup', array('index','addpopup','getrequests','add','edit','delete','view','Components Group'));
		 ...
		 $acl->addResource(new Zend_Acl_Resource('default:downloadpayslip'));
                            $acl->allow('finance', 'default:downloadpayslip', array('index','addpopup','getrequests','add','edit','delete','view','Download Payslip'));

		 $acl->addResource(new Zend_Acl_Resource('default:educationlevelcode'));
                            $acl->allow('finance', 'default:educationlevelcode', array('index','view','Education Levels'));

		 $acl->addResource(new Zend_Acl_Resource('default:eeoccategory'));
                            $acl->allow('finance', 'default:eeoccategory', array('index','view','EEOC Categories'));

		 $acl->addResource(new Zend_Acl_Resource('default:empconfiguration'));
                            $acl->allow('finance', 'default:empconfiguration', array('index','Employee Tabs'));

		 $acl->addResource(new Zend_Acl_Resource('default:empleavesummary'));
                            $acl->allow('finance', 'default:empleavesummary', array('index','statusid','view','Employee Leaves Summary'));

		 $acl->addResource(new Zend_Acl_Resource('default:employee'));
                            $acl->allow('finance', 'default:employee', array('getemprequi','index','changeorghead','getdepartments','getpositions','getempreportingmanagers','makeactiveinactive','changereportingmanager','addemppopup','uploadexcel','getindividualempdetails','view','Employees'));

		 $acl->addResource(new Zend_Acl_Resource('default:employeecomponents'));
                            $acl->allow('finance', 'default:employeecomponents', array('index','addpopup','getrequests','add','edit','delete','view','Employee Components'));

		 $acl->addResource(new Zend_Acl_Resource('default:employeeleavetypes'));
                            $acl->allow('finance', 'default:employeeleavetypes', array('index','view','Leave Types'));

		 $acl->addResource(new Zend_Acl_Resource('default:employmentstatus'));
                            $acl->allow('finance', 'default:employmentstatus', array('index','addpopup','view','Employment Status'));

		 $acl->addResource(new Zend_Acl_Resource('default:feedforwardemployee'));
                            $acl->allow('finance', 'default:feedforwardemployee', array('index','save','edit','view','Appraise Your Manager'));

		 $acl->addResource(new Zend_Acl_Resource('default:formulafields'));
                            $acl->allow('finance', 'default:formulafields', array('index','addpopup','getrequests','add','edit','delete','view','Formula Fields'));

		 $acl->addResource(new Zend_Acl_Resource('default:generatepayroll'));
                            $acl->allow('finance', 'default:generatepayroll', array('index','addpopup','getrequests','add','edit','delete','view','Generate Payroll'));

		 $acl->addResource(new Zend_Acl_Resource('default:holidaydates'));
                            $acl->allow('finance', 'default:holidaydates', array('index','addpopup','viewpopup','editpopup','view','Manage Holidays'));

		 $acl->addResource(new Zend_Acl_Resource('default:holidaygroups'));
                            $acl->allow('finance', 'default:holidaygroups', array('index','getempnames','getholidaynames','addpopup','view','Manage Holiday Group'));
		 ...
		 $acl->addResource(new Zend_Acl_Resource('default:identitydocuments'));
                            $acl->allow('finance', 'default:identitydocuments', array('index','view','Identity Documents'));
		 ...
		 $acl->addResource(new Zend_Acl_Resource('default:jobtitles'));
                            $acl->allow('finance', 'default:jobtitles', array('index','addpopup','view','Job Titles'));

		 $acl->addResource(new Zend_Acl_Resource('default:leavemanagement'));
                            $acl->allow('finance', 'default:leavemanagement', array('index','view','Leave Management Options'));
		 ...
		 $acl->addResource(new Zend_Acl_Resource('default:manageremployeevacations'));
                            $acl->allow('finance', 'default:manageremployeevacations', array('index','edit','view','Manager Employee Leaves'));
		 ...
		 $acl->addResource(new Zend_Acl_Resource('default:myteamappraisal'));
                            $acl->allow('finance', 'default:myteamappraisal', array('savelineresponse','savemngresponse','getempcontent','index','getsearchedempcontent','getsearchedstatus','downloadpdf','downloadUploadedFile','My Team Appraisal'));

		 $acl->addResource(new Zend_Acl_Resource('default:payfrequency'));
                            $acl->allow('finance', 'default:payfrequency', array('index','addpopup','view','Pay Frequency'));

		 $acl->addResource(new Zend_Acl_Resource('default:payrollattendancereport'));
                            $acl->allow('finance', 'default:payrollattendancereport', array('index','addpopup','getrequests','add','edit','delete','view','Attendance Report'));

		 $acl->addResource(new Zend_Acl_Resource('default:payrollemployeeadvances'));
                            $acl->allow('finance', 'default:payrollemployeeadvances', array('index','add','edit','delete','view','Employee Advances'));

		 $acl->addResource(new Zend_Acl_Resource('default:payrollmyadvances'));
                            $acl->allow('finance', 'default:payrollmyadvances', array('index','add','edit','delete','view','My Advances'));

		 $acl->addResource(new Zend_Acl_Resource('default:payrollperiods'));
                            $acl->allow('finance', 'default:payrollperiods', array('index','addpopup','getrequests','add','edit','delete','view','Payroll Periods'));

		 $acl->addResource(new Zend_Acl_Resource('default:pendingleaves'));
                            $acl->allow('finance', 'default:pendingleaves', array('index','delete','view','My Leaves'));

		 $acl->addResource(new Zend_Acl_Resource('default:positions'));
                            $acl->allow('finance', 'default:positions', array('index','addpopup','view','Positions'));

		 $acl->addResource(new Zend_Acl_Resource('default:remunerationbasis'));
                            $acl->allow('finance', 'default:remunerationbasis', array('index','view','Remuneration Basis'));
		 ...
		 $acl->addResource(new Zend_Acl_Resource('default:servicedeskconf'));
                            $acl->allow('finance', 'default:servicedeskconf', array('index','getemployees','getapprover','getbunitimplementation','getassets','add','edit','delete','view','Settings'));

		 $acl->addResource(new Zend_Acl_Resource('default:servicedeskdepartment'));
                            $acl->allow('finance', 'default:servicedeskdepartment', array('index','addpopup','getrequests','add','edit','delete','view','Categories'));

		 $acl->addResource(new Zend_Acl_Resource('default:servicedeskrequest'));
                            $acl->allow('finance', 'default:servicedeskrequest', array('index','add','edit','delete','view','Request Types'));

		 $acl->addResource(new Zend_Acl_Resource('default:servicerequests'));
                            $servicerequests_add = 'yes';
                                if($this->id_param == '' && $servicerequests_add == 'yes')
                                    $acl->allow('finance','default:servicerequests', array('index','uploadsave','uploaddelete','view','getrequests','changestatus','checkrequeststatus','getuserassets','index','add','uploadsave','uploaddelete','view','getrequests','changestatus','checkrequeststatus','getuserassets','edit'));

                                else
                                    $acl->allow('finance','default:servicerequests', array('index','uploadsave','uploaddelete','view','getrequests','changestatus','checkrequeststatus','getuserassets','index','add','uploadsave','uploaddelete','view','getrequests','changestatus','checkrequeststatus','getuserassets'));

                                
		 $acl->addResource(new Zend_Acl_Resource('default:usermanagement'));
                            $acl->allow('finance', 'default:usermanagement', array('index','saveupdate','getemailofuser','view','Manage External Users'));

		 $acl->addResource(new Zend_Acl_Resource('default:workeligibilitydoctypes'));
                            $acl->allow('finance', 'default:workeligibilitydoctypes', array('index','addpopup','view','Work Eligibility Document Types'));

		 $acl->addResource(new Zend_Acl_Resource('assets:assetcategories'));
                            $acl->allow('finance', 'assets:assetcategories', array('index','addpopup','addsubcatpopup','assetuserlog','add','edit','delete','view','Asset Categories'));

		 $acl->addResource(new Zend_Acl_Resource('assets:assets'));
                            $acl->allow('finance', 'assets:assets', array('index','uploadsave','uploaddelete','getsubcategories','deleteimage','downloadimage','getemployeesdata','add','edit','delete','view','Assets'));

		 $acl->addResource(new Zend_Acl_Resource('expenses:advances'));
                            $acl->allow('finance', 'expenses:advances', array('index','getprojects','myadvances','viewmoreadvances','clearadvancesdata','addreturnpopup','add','edit','delete','view','Advances'));

		 $acl->addResource(new Zend_Acl_Resource('expenses:employeeadvances'));
                            $acl->allow('finance', 'expenses:employeeadvances', array('index','add','edit','delete','view','Employee Advances'));

		 $acl->addResource(new Zend_Acl_Resource('expenses:expensecategories'));
                            $acl->allow('finance', 'expenses:expensecategories', array('index','add','edit','delete','view','Category'));

		 $acl->addResource(new Zend_Acl_Resource('expenses:expenses'));
                            $acl->allow('finance', 'expenses:expenses', array('index','clone','addpopup','uploadsave','uploaddelete','displayreceipts','addtrippopup','submitexpense','addreceiptimage','expensestatus','listreportingmangers','viewmoremanagers','forwardexpenseto','downloadexpensepdf','bulkexpenses','getcategories','getprojects','getcurrency','uploadedfiles','add','edit','delete','view','Expenses'));

		 $acl->addResource(new Zend_Acl_Resource('expenses:myemployeeexpenses'));
                            $acl->allow('finance', 'expenses:myemployeeexpenses', array('index','add','edit','delete','view','My Employee Expenses'));

		 $acl->addResource(new Zend_Acl_Resource('expenses:paymentmode'));
                            $acl->allow('finance', 'expenses:paymentmode', array('index','add','edit','delete','view','Payment Mode'));

		 $acl->addResource(new Zend_Acl_Resource('expenses:receipts'));
                            $acl->allow('finance', 'expenses:receipts', array('index','downloadreceipt','downloadexpensereceipt','deletereceipt','uploadsave','displayreceipts','viewmorereceipts','listexpenses','addreceipttoexpense','viewmoreexpenses','cleardata','showreceiptspopup','listtrips','viewmoretrips','addexpensetotrip','add','edit','delete','view','Receipts'));

		 $acl->addResource(new Zend_Acl_Resource('expenses:trips'));
                            $acl->allow('finance', 'expenses:trips', array('index','addpopup','tripstatus','deleteexpense','downloadtrippdf','add','edit','delete','view','Trips'));
